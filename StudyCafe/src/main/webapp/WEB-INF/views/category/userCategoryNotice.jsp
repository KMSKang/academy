...
<body>
	...
	<div style="position: absolute;">
		<ul style="list-style: none; font-weight: bold;">
			<li><a href="/notice/main" id="left_a" style="color: black; text-decoration: none;">공지사항</a></li>
			<li><a href="/event/main" id="left_a" style="color: black; text-decoration: none;">이벤트</a></li>
		</ul>
	</div>
<!-- <li><a href="/noticeMain.do" id="top_a">공지사항</a></li>
				<li><a href="/eventMain.do" id="top_a">이벤트</a></li> -->
</body>
</html>